...
export EXECUTABLE=pc_armv7_vfpv3 ARCH='-fsigned-char -ftree-vectorize -march=armv7-a -mtune=cortex-a9 -mfpu=vfpv3-d16 -mfloat-abi=hard' BZ2=libbz2_armhf
#export EXECUTABLE=pc_armv7_vfpv4 ARCH='-fsigned-char -ftree-vectorize -march=armv7-a -mtune=cortex-a7 -mfpu=vfpv4 -mfloat-abi=hard' BZ2=libbz2_armhf
